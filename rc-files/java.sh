...
alias mcict="mvn -T 1C clean install -Dmaven.test.skip=true"             # maven clean install skip test execution but compile them
...
alias mcfi="mvn -T 1C clean install -DskipTests=true -Dmaven.test.skip=true -nsu -o"     # maven clean install skip tests offline