...
alias mist="mvn -T 1C install -Dmaven.test.skip=true"                   # maven install skip test execution and compilation
alias mfi="mist -nsu -o"                                                # maven install skip tests offline
alias mcfi="mvn -T 1C clean install -Dmaven.test.skip=true -nsu -o"     # maven clean install skip tests offline